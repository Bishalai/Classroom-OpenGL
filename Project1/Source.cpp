...
bool Tutorial22::Init()
{
    ...
    if (!pMesh->LoadMesh("../assets/classroom1.obj")) {
        return false;
    }
...
void Tutorial22::RenderSceneCB()
{
    ...
    pointLights[0].WorldPosition.y = 5.0f;
    ...
    pointLights[1].WorldPosition.y = 5.0f;
    pointLights[1].WorldPosition.z = 3.0f;
...
int main(int argc, char** argv)
{
    ...
    int win = glutCreateWindow("Classroom");
    printf("window id: %d\n", win);
